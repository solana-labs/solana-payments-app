...
import { USDC_PUBKEY, WSOL_PUBKEY } from "./configs/pubkeys.config";
import { TokenInformation } from "./configs/token-list.config";
import { PayRequest } from "./schemas/pay-request.schema";
import { createTransferIx } from "./services/builders/transfer-ix.builder";
import { createSwapIx } from "./services/swaps/create-swap-ix.service";
...
const createPayTransaction = async (
  ...
  if (
    payRequest.sendingToken.toBase58() != payRequest.receivingToken.toBase58()
  ) {
