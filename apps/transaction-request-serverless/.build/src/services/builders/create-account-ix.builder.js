...
export var createAccountIx = function (newAccountPubkey, fromPubkey, connection) { return __awaiter(void 0, void 0, void 0, function () {
    var rent, ix;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, connection.getMinimumBalanceForRentExemption(0)];
            case 1:
                rent = _a.sent();
                ix = web3.SystemProgram.createAccount({
...
//# sourceMappingURL=create-account-ix.builder.js.map