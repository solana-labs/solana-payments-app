    ...
    return (
        <div className="flex flex-col mt-8">
            ...
            <div className='flex flex-col items-center'>
                <button className='btn btn-md w-4/5 outline-none border-2 border-black hover:bg-white bg-white text-black flex justify-center items-center normal-case mt-12' onClick={retryTransaction}>
