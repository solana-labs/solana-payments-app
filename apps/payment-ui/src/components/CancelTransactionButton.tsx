...
const CancelTransactionButton = () => {
    ...
    return (
        <div className="flex flex-col justify-end h-full">
            <div className="pb-6">
                <button disabled={isDisabled()} className='btn w-full outline-none disabled:bg-gray-200 disabled:text-gray-400 border-2 border-black hover:bg-white bg-white text-black flex justify-center items-center normal-case' onClick={cancelTransaction}>
