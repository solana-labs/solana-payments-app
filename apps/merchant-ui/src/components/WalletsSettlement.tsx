    ...
    return (
        <DefaultLayoutContent className={props.className}>
            ...
            <div className="mt-24 gap-x-8 lg:grid lg:grid-cols-[max-content,1fr]">
                <DefaultLayoutHeader className="col-span-2 mb-9">My Wallets</DefaultLayoutHeader>
                <div className="max-w-[280px]">
                    <div className="text-sm font-medium text-black">Payment Receipt Address</div>
                    <div className="text-sm text-neutral-600">Automatically receive all payments to this address.</div>
                </div>
                <AddressInput
                ...
                />
                <DefaultLayoutHeader className="mt-16 mb-9 col-span-2">Settlement</DefaultLayoutHeader>
                <div className="max-w-[280px]">
