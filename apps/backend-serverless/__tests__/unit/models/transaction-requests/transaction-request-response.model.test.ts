...
describe('unit testing transaction request response model', () => {
    it('valid transaction request response model', () => {
        ...
        expect(() => {
            parseAndValidateTransactionRequestResponse(validTransactionRequestResponse);
        }).not.toThrow();
    });
    ...
    it('missing transaction value', () => {
        ...
        expect(() => {
            parseAndValidateTransactionRequestResponse(invalidTransactionRequestResponse);
        }).toThrow();
    });
});
