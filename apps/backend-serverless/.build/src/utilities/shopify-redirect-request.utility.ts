import { AppRedirectQueryParam, appRedirectQueryParmSchema } from '../models/redirect-query-params.model'
import queryString from 'query-string';
import crypto from 'crypto-js'

export const verifyAndParseShopifyRedirectRequest = (appRedirectQuery: any): AppRedirectQueryParam => {
