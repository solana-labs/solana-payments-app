export const SEED_DATA = {
    ...
    refundRecords: [
        ...
        {
            id: 'Ht2uiLqbHXYaTZjxTQJpGJQUAozFFzycw4EAfSFbacS6',
            status: 'pending',
            amount: 29.9,
            currency: 'USD',
            shopId: 'NHMXM5IdzsBGcVsMcGy8L7Kq',
            shopGid: 'gid://shopify/RefundSession/NHMXM5IdzsBGcVsMcGy8L7Kq',
            shopPaymentId: 'paymentId4',
            test: 1,
            merchantId: 'HnWuBCBMZrug12qFG9t8b8KEoHbtGMq2X3EyyQZBLQqV',
            requestedAt: '2023-05-25T21:52:37.974Z',
            usdcAmount: 29.91052850603412,
        },
    ],
};
