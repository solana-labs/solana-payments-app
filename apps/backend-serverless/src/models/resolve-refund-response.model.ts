...
export const resolveRefundResponseDataSchema = object().shape({
    refundSessionResolve: resolveRefundResponseRefundSessionResolveSchema.required(),
...
export const parseAndValidateResolveRefundResponse = (resolveRefundResponeBody: any): ResolveRefundResponse => {
    ...
    try {
        ...
        if (error instanceof Error) {
            ...
            throw new Error('Could not parse the resolve refund response body. Unknown Reason.');
        }
    }
