...
export type ShopifyRequestHeaders = InferType<
  typeof shopifyRequestHeadersScheme
>;

export const parseAndValidateShopifyRequestHeaders = (
  shopifyRequestHeaders: any
