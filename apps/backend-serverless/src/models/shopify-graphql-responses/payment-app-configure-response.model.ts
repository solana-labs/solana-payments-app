...
export const resolvePaymentResponseDataSchema = object().shape({
    paymentSessionResolve: resolvePaymentResponsePaymentSessionResolveSchema.required(),
});
...
export type ResolvePaymentResponse = InferType<typeof paymentAppConfigureResponseSchema>;
