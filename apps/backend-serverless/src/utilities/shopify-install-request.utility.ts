import { AppInstallQueryParam, appInstallQueryParmSchema } from '../models/install-query-params.model'
import queryString from "query-string"
import crypto from "crypto-js"

export const verifyAndParseShopifyInstallRequest = (appInstallQuery: any): AppInstallQueryParam => {
