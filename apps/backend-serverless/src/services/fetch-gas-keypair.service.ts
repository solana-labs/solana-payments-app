...
export const fetchGasKeypair = async (): Promise<web3.Keypair> => {
    ...
    // AWS.config.update({
    //     region: region, // use your AWS region from environment variables
    //     accessKeyId: accessKey, // use your Access Key ID from environment variables
    //     secretAccessKey: secretKey, // use your Secret Access Key from environment variables
    // });
