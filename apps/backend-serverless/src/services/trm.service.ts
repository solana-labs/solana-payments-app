...
import { TRM_API_KEY, TRM_CHAIN_SOLANA_ID, TRM_SCREEN_URL } from '../configs/trm.config.js';
import { TrmWalletScreenResponse, trmWalletScreenResponseSchema } from '../models/trm-wallet-screen-response.model.js';
...
export const parseAndValidateTrmResponse = (response: any): TrmWalletScreenResponse => {
