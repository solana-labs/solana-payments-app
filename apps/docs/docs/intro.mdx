---
title: Solana Pay x Commerce Platforms
description: Seamless eCommerce transactions with Solana Pay. Easy setup, low fees, and fast processing for merchants.
image: ./assets/favicon-32x32.png
keywords: [Solana, eCommerce, Shopify, crypto payments, USDC, Solana Pay]
sidebar_position: 1
slug: /
---
...
<p align="center">
    ...
    &nbsp;|&nbsp;
    <b>
        <a href="./merchants/onboarding">merchant onboarding</a>
    </b>
    &nbsp;|&nbsp;
    <br />
